...
# Phase 5k follow-on closures:
#   * Disjunctive 3-conjunct (``Maria, Juan, o Pedro``) closed in
#     Phase 5n.A Commit 20 — see test_phase5n_3conj_or_coord.py.
#   * 4-conjunct flat (``Maria, Juan, Pedro, at Ana``) closed in
#     Phase 5n.A Commit 19 — see test_phase5n_4conj_coord.py.
# 5+-conjunct flat coord remains pinned at 0-parse in
# test_phase5n_4conj_coord.py::TestFivePlusConjunctDeferred (root
# cause + fix paths are documented in tgllfg-phase-5n.md
# Commit 19/19a; tracked for Phase 5n.C).
