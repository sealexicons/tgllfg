...
data/tgl/       YAML lexicon: nouns / verbs / adjectives / numerals /
                ...
                per-entry files; exemplars/ + references/ are gitignored
...
scripts/        harvest_exemplars.py, generate_coverage_corpus.py,
                check_parses_unchanged.py
```
...
- **Audit harvest output**: `data/tgl/exemplars/` (gitignored). Generated by
