...
**Date:** 2026-05-07. Refreshed after Phase 5k Commit 10 (closes the
Phase 5k corpus expansion before the closing-docs sweep).

This document summarises the parser's coverage on the 1315-sentence
