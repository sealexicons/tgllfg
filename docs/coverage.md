...
**Date:** 2026-05-06. Refreshed after Phase 5j Commit 10 (closes the
Phase 5j corpus expansion before the closing-docs sweep).

This document summarises the parser's coverage on the 1294-sentence
